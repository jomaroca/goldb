...
<body id="body">
	...
	<form action="listaJugadores.php" method="GET">
	...
	<a href="../administrador/listaBuscar.php"><button class="btn btn-filter">Filtrar</button></a>
    </div>
	...
	<?php 
		...
		pintaListaJugadores($orden);
		
	?>
	</div>

	<a class="enlace" href="../administrador/administrador.php">Volver a Administrador</a><br><br>
